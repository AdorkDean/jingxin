...
#import "CustCell.h"
@interface CgInformationSearchVC ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>
...
@implementation CgInformationSearchVC
{
...
- (void)search{
    if (_block) {_block(_orderTextfield.text,_startButton.titleLabel.text,_endButton.titleLabel.text);
    }
