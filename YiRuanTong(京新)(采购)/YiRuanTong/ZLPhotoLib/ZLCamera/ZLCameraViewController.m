...
-(void)takePhoto
{
    ...
    NSString *deviceStr = device.model;
...
//            UIPopoverController *popover = [[UIPopoverController alloc] initWithContentViewController:camreaVc];
//            _popoverController1 = popover;
//            [_popoverController1 presentPopoverFromRect:CGRectMake(0, 0, KscreenWidth, 300) inView:self.view permittedArrowDirections:UIPopoverArrowDirectionAny animated:YES];
