...
@interface CgInformationDetailVC : BaseViewController<UIScrollViewDelegate,UITableViewDataSource,UITableViewDelegate>

@property(nonatomic,retain) UIScrollView *dingDanScrollView; //
@property(nonatomic,retain) UITableView *tbView;
//客户信息

@property (nonatomic,strong) CgLLManageModel *model;
