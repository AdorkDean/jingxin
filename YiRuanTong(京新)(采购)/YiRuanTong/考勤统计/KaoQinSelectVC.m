...
#import "CustModel.h"
@interface KaoQinSelectVC ()<UITextFieldDelegate,UITableViewDelegate,UITableViewDataSource>
...
- (void)searchcust{
    ...
    NSDictionary *params = @{@"action":@"getPrincipals",@"table":@"ddxx",@"rows":@"20",@"page":[NSString stringWithFormat:@"%zi",_salerpage],@"mobile":@"true",@"params":[NSString stringWithFormat:@"{\"nameLIKE\":\"%@\"}",custName]};
...
//    NSDictionary *params = @{@"rows":@"20",@"mobile":@"true",@"page":[NSString stringWithFormat:@"%zi",_salerpage],@"action":@"signStatistics",@"params":[NSString stringWithFormat:@"{\"empidEQ\":\"%@\",\"dateGE\":\"%@\",\"dateLE\":\"%@\"}",@"",@"",@""]};
//    if (_salerpage == 1) {
//        [_salerArray removeAllObjects];
//    }
//    [DataPost requestAFWithUrl:urlStr params:params finishDidBlock:^(AFHTTPRequestOperationManager *operation, id result) {
