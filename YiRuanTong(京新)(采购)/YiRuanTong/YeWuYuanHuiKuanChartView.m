...
#import "UUChart.h"
#import "UIViewExt.h"
@interface YeWuYuanHuiKuanChartView ()<UUChartDataSource,UIScrollViewDelegate>{
...
@implementation YeWuYuanHuiKuanChartView
...
- (NSArray *)UUChart_yValueArray:(UUChart *)chart
{
    ...
    NSArray *ary1 = _sendData;   //第一列
    NSArray *ary2 = _returnData;   //第二列
