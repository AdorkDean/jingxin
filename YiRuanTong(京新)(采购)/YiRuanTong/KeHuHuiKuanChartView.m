...
#import "UUChart.h"
#import "UIViewExt.h"
@interface KeHuHuiKuanChartView ()<UUChartDataSource,UIScrollViewDelegate>{
...
@implementation KeHuHuiKuanChartView
...
- (void)initChartView{
    ...
    //
    UILabel *label1 = [[UILabel alloc] initWithFrame:CGRectMake(40, mainScrollView.bottom + 10 , 80, 20)];
    ...
    //
    UILabel *label2 = [[UILabel alloc] initWithFrame:CGRectMake(KscreenWidth - 120, mainScrollView.bottom + 10 , 80, 20)];
