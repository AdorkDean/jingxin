...
@interface JDXJDetailView (){
    
}
@property(nonatomic,retain)UIScrollView *mainScrollView;
@end

@implementation JDXJDetailView
...
- (void)initDetailView{
    ...
    label11.text = _model.routingname;
    ...
    label22.text = [NSString stringWithFormat:@"%@",_model.routingtelno];
    ...
    label44.text = _model.custnametelno;
    ...
    if (_model.nextroutingdate.length > 0) {
        NSString *str = [NSString stringWithFormat:@"%@",_model.nextroutingdate];
        NSRange range = {0,10};
        str = [str substringWithRange:range];
        label66.text = str;
    }
    ...
    label77.text = _model.routingsituation;
