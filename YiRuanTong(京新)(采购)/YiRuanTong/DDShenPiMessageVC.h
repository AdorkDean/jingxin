...
@interface DDShenPiMessageVC : BaseViewController<UIScrollViewDelegate>
...
//@property(nonatomic,assign)NSInteger selectIndex;    //选择的行数
@property(nonatomic,retain)NSString *wuliuID;   //物流ID
@property(nonatomic,retain)NSDictionary *wuLiuData; //物流的数据
