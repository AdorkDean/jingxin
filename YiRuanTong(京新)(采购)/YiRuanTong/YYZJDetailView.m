...
@interface YYZJDetailView ()
@property(nonatomic,retain)UIScrollView *mainScrollView;
@end

@implementation YYZJDetailView
...
- (void)initDetailView{
    ...
    label11.text = _model.salername;
    
    UILabel * label2 = [[UILabel alloc]initWithFrame:CGRectMake(10, label1.bottom + 1, 80, 40)];
    label2.text = @"客户名称";
    ...
    label22.text = [NSString stringWithFormat:@"%@",_model.custname];
    ...
    if (_model.reportdate.length > 0) {
        NSString *str = _model.reportdate;
        NSRange range = {0,10};
    ...
    label66.text =  [NSString stringWithFormat:@"%@",_model.linkertel];
