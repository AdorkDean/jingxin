...
@interface SHHFDetailView ()
@property(nonatomic,retain)UIScrollView *mainScrollView;
@end

@implementation SHHFDetailView
...
- (void)initDetailView{
    ...
    label11.text = _model.visitorname;
    ...
    label22.text = [NSString stringWithFormat:@"%@",_model.repairname];
    ...
    label66.text =  [NSString stringWithFormat:@"%@",_model.servicelevelname];
